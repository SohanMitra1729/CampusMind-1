...
-- ── 9. Persistent Bot Sessions & Atomic Vote RPC ────────────────────────────
...
CREATE POLICY "Service role full access on bot_sessions" ON public.bot_sessions FOR ALL USING (true) WITH CHECK (true);
